...
// 	"os"
// 	"time"
// 	"wallet-services-backend-go/cmd/config"
// 	"wallet-services-backend-go/pkg/lib/util"

// 	"github.com/sirupsen/logrus"

// 	ctxLib "wallet-services-backend-go/pkg/lib/context"
// 	errs "wallet-services-backend-go/pkg/lib/error"
// )
...
// func setupLogger() {
// 	pwd, _ := os.Getwd()
// 	file, err := os.OpenFile(pwd+logsDir+"app-"+currentDate+".log", os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0o666)
// 	if err == nil {
// 		log.Out = file
// 	} else {
